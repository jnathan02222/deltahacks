  ...
  return (
    <main className="flex flex-col  max-h-screen justify-center	items-center p-24">
      ...
      <form className="flex flex-col">
        <div className="flex justify-center items-center border-2 border-grey-500 border-dashed	 w-128 rounded-md	w-96 mt-8 h-96 bg-gray-100">
          ...
          <input type="file" id="notes" name="note" className="w-[100px] hidden"/>
        </div>
